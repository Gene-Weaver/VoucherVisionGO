"""
This estimate will evolve in time. Cloud computing is not transparent about inference impacts
and a lot of factors can influence C02 emissions. We found this article to be insightful:
    https://towardsdatascience.com/is-googles-reveal-of-geminis-impact-progress-or-greenwashing/

We provide multiple estimate of C)2 emissions and energy usage. If you come across a more accurate 
way of estimating LLM inference impacts, specifically for Google Cloud infrastructre, we'd love 
to hear about it and incorporate it into these estimates.

Here we only include estimate of Google Cloud because that is the infrastructure powering 
the VoucherVisionGO API. 

Assumptions:
- For a typical herbarium specimen
        OCR: 
            Total  = 2500 tokens
            Input  = 2000 tokens
            Output =  500 tokens
...
- Water use is extremely complex and varies signifcantly by data center. We rely on Google's estimate.
- We assume the "cost" of input and output tokens are equivalent, though "thinking" models may differ.

Estimates:
- source_google
    Original: https://cloud.google.com/blog/products/infrastructure/measuring-the-environmental-impact-of-ai-inference
    Archive: https://web.archive.org/web/20251001194210/https://cloud.google.com/blog/products/infrastructure/measuring-the-environmental-impact-of-ai-inference
    Google researchers, not peer reviewed

- source_oviedo
    Original: https://arxiv.org/pdf/2509.20241
    Microsoft researchers, not peer reviewed


https://web.archive.org/web/20251109020239/https://assets.publishing.service.gov.uk/media/62aee1fbe90e0765d523ca33/2022-ghg-cf-methodology-paper.pdf?utm_source=chatgpt.com
"""
import json
...
if __name__ == "__main__":
    ...
    # Example usage
    # for n in [5000, None, 0, -500, 100, 2000, 10000]:
    #     print(json.dumps(estimate_impact(n), indent=2))