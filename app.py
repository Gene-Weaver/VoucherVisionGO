    ...
    <html>
      <head>
        ...
        <style>
          ...
          /* New styles for API keys access section */
          .api-keys-access {
            background-color: #e9f5ff;
            border-radius: 4px;
            padding: 15px;
        ...
        <div class="container">
          ...
          <div class="usage-instructions">
            ...
            <ul class="nav nav-tabs" id="auth-methods" role="tablist">
                ...
                <button class="nav-link active" id="token-tab" data-bs-toggle="tab" data-bs-target="#token-content" type="button" role="tab" aria-controls="token-content" aria-selected="true">Firebase Token Authentication</button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                checkApiKeyPermission(firebase.auth().currentUser)
