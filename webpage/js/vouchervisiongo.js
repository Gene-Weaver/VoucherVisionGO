...
const STEP_INFO = {
    step1: {
        ...
        number: '1',
        sections: [
            { title: 'Recommendations', body: 'Use <strong><code>gemini-3.1-flash-lite</code></strong> for both OCR and parsing\u2014it performs comparably to more expensive models at a fraction of the cost.<br><br><strong><code>gemini-3.1-pro-preview</code></strong> is limited to 100 calls per user.' },
