...
# Usage examples:
# Single image:
# python client.py --server https://vouchervision-go-738307415303.us-central1.run.app --image "D:/Dropbox/VoucherVision/demo/demo_images/MICH_16205594_Poaceae_Jouvea_pilosa.jpg" --output-dir ./results --verbose

# URL image:
# python client.py --server https://vouchervision-go-738307415303.us-central1.run.app --image "https://swbiodiversity.org/imglib/h_seinet/seinet/KHD/KHD00041/KHD00041592_lg.jpg" --output-dir ./results --verbose

# Directory of images:
# python client.py --server https://vouchervision-go-738307415303.us-central1.run.app --directory ./images --output-dir ./results --verbose

# List of files:
# python client.py --server https://vouchervision-go-738307415303.us-central1.run.app --file-list file_list.csv --output-dir ./results --verbose

# Custom prompt:
# python client.py --server https://vouchervision-go-738307415303.us-central1.run.app --image "https://swbiodiversity.org/imglib/h_seinet/seinet/KHD/KHD00041/KHD00041592_lg.jpg" --output-dir ./results --verbose --prompt "SLTPvM_default_chromosome.yaml"

# Save results to CSV:
# python client.py --server https://vouchervision-go-738307415303.us-central1.run.app --directory ./images --output-dir ./results --save-to-csv